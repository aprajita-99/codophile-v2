...
export default function TailwindEffectsPlayground() {
    ...
    const elementClasses = `${shadow} ${opacity} ${blur} ${mixBlend} w-48 h-48 bg-purple-500 rounded-xl flex items-center justify-center text-foreground font-bold text-xl`;
