...
export default function TailwindAnimationsPlayground() {
    ...
    const elementClasses = `${animate} ${transitionProperty} ${duration} ${ease} w-32 h-32 bg-linear-to-br from-violet-500 to-purple-600 rounded-xl shadow-xl flex items-center justify-center text-foreground font-bold`;
    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-cyan-500/30 font-sans">
            ...
            <div className="pt-24 pb-20 px-4 md:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 min-h-[calc(100vh-100px)]">
                ...
                >
                    <div className="flex-1 min-h-[400px] rounded-2xl border border-foreground/10 relative overflow-hidden bg-[#0a0a0a] p-8 flex flex-col items-center justify-center">
                        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]" />

                        <div className="mb-8 text-gray-600 dark:text-gray-400 text-sm">
