...
export default function TailwindBordersPlayground() {
    ...
    const elementClasses = `w-48 h-48 bg-foreground/5 ${rounded} ${borderWidth} ${borderColor} ${borderStyle} flex items-center justify-center text-gray-600 dark:text-gray-400`;
