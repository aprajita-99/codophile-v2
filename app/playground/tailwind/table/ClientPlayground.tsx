                    ...
                    <div className="flex-1 overflow-y-auto pr-2 space-y-6 custom-scrollbar max-h-[600px] lg:max-h-[calc(100vh-250px)]">
                        ...
                        <ControlGroup title="Layout">
                            ...
                            <div className="flex items-center justify-between pt-2">
                                <label className="text-xs text-gray-700 dark:text-gray-300">Width Full</label>
                                <button
                        ...
                        <ControlGroup title="Borders & Spacing">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs text-gray-700 dark:text-gray-300">Border Color</label>
                                <select
                                    value={borderColor}
                                ...
                                >
                                    {borderColors.map(opt => (
                                        <option key={opt.value} value={opt.value} className="bg-gray-900 text-foreground">
                                            {opt.label}
                                        </option>
                                    ))}
                                </select>
                ...
                >
                    ...
                    <div className="flex-1 min-h-[400px] rounded-2xl border border-foreground/10 relative overflow-hidden flex flex-col items-center justify-center bg-[#111] p-8">
                        ...
                        <div className="relative z-10 w-full max-w-full overflow-x-auto rounded-lg shadow-xl">
                            ...
                            `}>
                                <thead className="text-xs text-foreground uppercase bg-gray-800">
                                    <tr>
                                ...
                                <tbody>
                                    {rows.map((row, idx) => (
                                        ...
                                        `}>
                                            <td className={`${padding} ${borderWidth} ${borderColor} ${textAlign} ${verticalAlign} font-medium text-foreground`}>
                                                {row.name}
                                            </td>
