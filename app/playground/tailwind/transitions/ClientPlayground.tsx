...
export default function TailwindTransitionsPlayground() {
    ...
    const elementClasses = `${property} ${behavior} ${duration} ${timing} ${delay} w-48 h-48 bg-indigo-600 scale-100 rotate-0 rounded-2xl shadow-xl flex items-center justify-center text-foreground font-bold text-center p-4 cursor-pointer`;
