                    ...
                    <div className="flex-1 min-h-[400px] rounded-2xl border border-foreground/10 relative overflow-hidden bg-[#0a0a0a] p-8 flex flex-col items-center justify-center">
                        ...
                        <div className="relative group">
                            ...
                            <div className={elementClasses}>
                                ...
                                <div className="absolute inset-0 flex items-center justify-center text-foreground/20 font-black text-6xl select-none pointer-events-none uppercase tracking-tighter">
                                    Mask
                                </div>
                            </div>
                        </div>
