...
export default function TailwindLayoutPlayground() {
    ...
    const containerClasses = `flex ${flexDirection} ${justifyContent} ${alignItems} ${gap} ${flexWrap} p-4 w-full h-full bg-foreground/5 rounded-lg border border-foreground/10 overflow-auto`;
    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-cyan-500/30 font-sans">
            ...
            <div className="pt-24 pb-20 px-4 md:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 min-h-[calc(100vh-100px)]">
                    ...
                    <div className="flex-1 overflow-y-auto pr-2 space-y-6 custom-scrollbar">
                        ...
                        <ControlGroup title="Items">
                            <div className="flex items-center justify-between">
                                <span className="text-xs text-gray-700 dark:text-gray-300">Count: {itemCount}</span>
                                <input
                                    type="range"
                                    min="1"
                                    max="12"
                ...
                >
                    <div className="flex-1 min-h-[400px] rounded-2xl border border-foreground/10 relative overflow-hidden bg-[#0a0a0a] p-8 flex flex-col">
